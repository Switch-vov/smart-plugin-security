...
import com.switchvov.smart4j.plugin.security.realm.SmartCustomRealm;
import com.switchvov.smart4j.plugin.security.realm.SmartJdbcRealm;
...
public class SmartSecurityFilter extends ShiroFilter {
    ...
    private void setRealms(WebSecurityManager webSecurityManager) {
        // 读取 smart4j.plugin.security.realms配置项
    ...
    private void addCustomRealm(Set<Realm> realms) {
        // 读取smart.plugin.security.custom.class
